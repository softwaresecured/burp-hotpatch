...
public class BurpJyConsoleView extends AbstractView<BurpJyConsoleControllerEvent, BurpJyConsoleModel, BurpJyConsoleModelEvent> {
    ...
    public BurpJyConsoleView(BurpJyConsoleModel model) {
        super(model);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jcmbScriptType.addItem(ScriptTypes.toFriendlyName(ScriptTypes.HTTP_HANDLER));
    ...
    public void attachListeners() {
        attach(jbtnNew,BurpJyConsoleControllerEvent.NEW);
        attach(jbtnSave,BurpJyConsoleControllerEvent.SAVE);
        attach(jbtnDelete,BurpJyConsoleControllerEvent.DELETE);
        attach(jbtnCancel,BurpJyConsoleControllerEvent.CANCEL);
        attach(jbtnRun,BurpJyConsoleControllerEvent.TOGGLE_SCRIPT_EXECUTION);
        attach(jbtnImport,BurpJyConsoleControllerEvent.IMPORT);
        ...
        attach(jradioStdout,BurpJyConsoleControllerEvent.OUTPUT_TYPE_STDOUT_SELECTED);
        attach(jradioStderr,BurpJyConsoleControllerEvent.OUTPUT_TYPE_STDERR_SELECTED);
        attachSelection(jtblScriptSelection,BurpJyConsoleControllerEvent.SCRIPT_SELECTION_UPDATED);
        attachTableModelChangeListener(getModel().getScriptSelectionModel(),BurpJyConsoleControllerEvent.TABLE_VALUE_UPDATED);
    }
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        handleEvent(BurpJyConsoleModelEvent.valueOf(evt.getPropertyName()), evt.getOldValue(), evt.getNewValue());
    }
}
